...
3. The script bumps `package.json`, runs `npm run check`, commits, pushes to `main`, and creates a GitHub Release with a tag like `pi-btw-with-imports-v0.1.1`.
